...
class ImportExport:
        ...
        try:
            ...
            with open(file_path, 'w', encoding='utf-8') as f:
                ...
                if not self.passwords:
                    f.write("Нет сохраненных паролей.\n")
                else:
    ...
    def import_from_json(self, file_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            for service, info in data.items():
                ...
                if not service.strip() or not password:
                    continue
                imported[service.strip()] = {
                    'username': username,
                    'password': password,
                    'url': info.get('url', ''),
            ...
            with open(file_path, 'r', encoding='utf-8') as csvfile:
                ...
                for row in reader:
                    ...
                    imported[service] = {
                        ...
                        'password': password,
                        'url': url,
                        'notes': ''   # заметки не заполняем автоматически
                    }
            return imported
        except Exception as e:
    ...
    def merge_passwords(self, new_passwords: Dict[str, Any],
        ...
        Returns:
            tuple: (обновленный словарь, количество добавленных, количество обновленных, количество пропущенных)
        """
        added = 0
        updated = 0
        skipped = 0
        ...
        return self.passwords, added, updated, skipped
